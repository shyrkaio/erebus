...
public class HypnosWatcher {
    ...
    public void listThenWatch(BiConsumer<Watcher.Action, String> callback)  {
        ...
        client.customResources(crdDefinitionContext, Hypnos.class, HypnosList.class,
                    HypnosDoneable.class).watch(
                            new Watcher<Hypnos>() {
            @Override
            ...
            public void onClose(KubernetesClientException cause) {
                if (cause != null) {
                    _log.info(this.getClass() + " is closed because :{" + cause.getCode() + ":" + cause.getStatus() + "}");
                }else{
